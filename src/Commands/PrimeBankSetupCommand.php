...
class PrimeBankSetupCommand extends Command
{
    ...
    private function addServiceVendor(): void
    {
        ...
        $vendor = [
            'service_vendor_name' => 'Prime Bank',
            'service_vendor_slug' => 'primebank',
            'service_vendor_data' => [],
            'logo_png' => 'data:image/png;base64,'.base64_encode(file_get_contents("{$dir}/logo_png/prime.png")),
            'logo_svg' => 'data:image/svg+xml;base64,'.base64_encode(file_get_contents("{$dir}/logo_svg/prime.svg")),
            'enabled' => false,
        ];
